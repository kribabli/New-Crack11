...
import static com.example.yoyoiq.Fragment.Admin.getLineNumber;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.getString("message").equalsIgnoreCase("Welcome back ")) {
                        ...
                        UserData userData = new UserData(userName, "", userEmail, userId, jsonObject.getString("referral_code"));
                    ...
                    if (loginResponse.getStatus().equalsIgnoreCase("true")) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                HelperData.referral_code = jsonObject.getString("referral_code");
                                wtf("Hulk-" + getClass().getName() + "-" + getLineNumber(), "HelperData.referral_code: " + HelperData.referral_code);
                                UserData userData = new UserData(username, mobile_no, email_id, user_id, jsonObject.getString("referral_code"));
                                sessionManager.saveUser(userData);
                            }
