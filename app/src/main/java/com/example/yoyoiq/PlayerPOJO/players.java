...
public class players {
    ...
    public players(int pid, String title, String short_name, String first_name, String last_name, String middle_name, String birthdate, String birthplace, String country, String thumb_url, String logo_url, String playing_role, String batting_style, String bowling_style, String fielding_position, String recent_match, String recent_appearance, String fantasy_player_rating, String nationality,int avg_points) {
        this.pid = pid;
        this.title = title;
