...
public class LiveLeaderboardFragment extends Fragment {
    ...
    String liveUrl = "https://adminapp.tech/crack11/ItsMe/all_apis.php?func=leaderboard_cron_for_match_id&match_id=52660";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            getLeaderBoardDataForCron(match_id);
    ...
    private void getLeaderBoardDataForCron(String match_id) throws JSONException {
        RequestQueue queue = Volley.newRequestQueue(getContext());
        StringRequest request = new StringRequest(Request.Method.POST, liveUrl, new com.android.volley.Response.Listener<String>() {
            @Override
